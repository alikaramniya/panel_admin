...
<head>
    ...
    <link rel="shortcut icon" href="public/img/admin/favicon.html">
    ...
    <link href="public/assets/admin/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
    ...
    <!--[if lt IE 9]-->
      <script src="public/js/admin/html5shiv.js"></script>
      <script src="public/js/admin/respond.min.js"></script>
    <!--[endif]-->
</head>
            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="index.php?c=menu&a=add">افزودن منوی جدید</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="index.php?c=procat&a=add">دسته بندی جدید</a></li>
